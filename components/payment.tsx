        ...
        <div className="grid gap-12 lg:grid-cols-12 items-start mt-12">
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="rounded-xl border border-primary/30 bg-primary/5 p-4 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs leading-relaxed">
              ...
              <a
                href={`https://wa.me/22605050577?text=${encodeURIComponent("Bonjour Alfred, je souhaite effectuer mon paiement pour le Bootcamp IA & Carrière et j'ai besoin d'assistance.")}`}
                target="_blank"
