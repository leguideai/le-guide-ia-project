    ...
    <section className="py-20 bg-background relative border-t border-border/50">
      <div className="mx-auto max-w-7xl px-4 md:px-8">
        ...
        <div className="grid gap-12 lg:grid-cols-12 items-center">
          ...
          >
            <div className="rounded-3xl border border-[#D4AF37]/40 bg-gradient-to-br from-[#D4AF37]/15 via-[#F5F8FF]/90 to-white p-8 shadow-xs glow-gold backdrop-blur-2xl max-w-md w-full space-y-6 relative overflow-hidden group hover:border-[#D4AF37]/70 transition-colors">
              <div className="flex items-center justify-between border-b border-border/60 pb-4">
                <div className="flex items-center gap-2">
                  <img src="/Logo%20avatar.png" alt="Logo Le Guide IA" className="size-8 rounded-lg object-cover" />
                  <span className="font-heading text-sm font-extrabold text-[#0E1E3F]">LE GUIDE <span className="text-primary">IA</span></span>
                </div>
                <span className="text-[9px] bg-gradient-to-r from-[#D4AF37] via-[#F3E5AB] to-[#AA7C11] text-slate-950 font-black border border-[#F3E5AB] px-2.5 py-1 rounded-full uppercase shadow-xs">
                  Officiel & Certifié
                </span>
              </div>
              ...
              <div className="text-center space-y-4 py-4 relative z-10">
                <motion.div
                  ...
                  className="inline-flex size-24 items-center justify-center rounded-full bg-[#D4AF37]/15 text-[#8A6A1F] border border-[#D4AF37]/40 shadow-xs mx-auto group-hover:scale-110 transition-transform duration-500"
                >
                  <Award className="size-12 text-[#8A6A1F]" />
                </motion.div>

                <div className="space-y-1.5">
                  <h3 className="font-heading text-xl font-extrabold text-[#0E1E3F]">
